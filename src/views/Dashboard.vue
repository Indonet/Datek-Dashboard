      ...
      <v-row class="mt-3 px-2">
        <v-col cols="12" lg="7" xl="6">
          <v-layout class="overflow-visible" style="height: 40px">
            <!-- <v-bottom-navigation v-model="value" class="rounded bottom-nav-wrapper" bg-color="grey-lighten-4"
              elevation="0" mandatory="true" grow> -->
            <!-- <v-btn :color="$root.getStatusClass(color)" class="mt-0 mx-0">
